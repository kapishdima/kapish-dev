...
export const Beszel: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 56 70" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Beszel</title>
    <defs>
      <linearGradient id="gradient" x1="0%" x2="100%" y1="20%" y2="120%">
