...
function CalendarRoot({
  ...
  rootRef,
  ...props
}: ComponentProps<NonNullable<DayPickerComponents["Root"]>>) {
  return (
    <div
...
function CalendarChevron({
  ...
  orientation,
  ...props
}: ComponentProps<NonNullable<DayPickerComponents["Chevron"]>>) {
  if (orientation === "left") {
...
function CalendarWeekNumber({
  children,
  ...props
}: ComponentProps<NonNullable<DayPickerComponents["WeekNumber"]>>) {
  return (
    <td {...props}>
...
function createDayButtonComponent(locale?: Partial<Locale>) {
  function CalendarDayButtonRenderer(
    props: ComponentProps<NonNullable<DayPickerComponents["DayButton"]>>
  ) {
    return <CalendarDayButton locale={locale} {...props} />;
  }
  return CalendarDayButtonRenderer;
}
...
function Calendar({
  ...
  const DayButtonComponent = useMemo(
    () => createDayButtonComponent(locale),
    [locale]
  );
